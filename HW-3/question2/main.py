...
if __name__ == '__main__':
	...
	# print(vec_queries[3],"\n")
	# print(vec_queries[2],"\n")
	# print(vec_queries[3]+vec_queries[2])
	# feature_names = tfidf_model.get_feature_names()
	# print(feature_names.index("lung"))
	# tfs = tfidf_model.transform(["lung"])
	# print(tfs)
	...
	rf_sim_matrix = relevance_feedback(vec_docs, copy.deepcopy(vec_queries), sim_matrix, gt)
	...
	rf_sim_matrix = relevance_feedback_exp(vec_docs, copy.deepcopy(vec_queries), sim_matrix, tfidf_model, gt)
